...
export function SpeekiLandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8 my-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button size="lg" variant="outline" className="w-sm sm:w-auto text-cyan-400 border-cyan-400 hover:bg-cyan-400 hover:text-gray-900">
              Learn More
            </Button>
          </div>
        </div>
